...
Original file is located at
    https://colab.research.google.com/drive/1IkTFRRRxCkr-nhcNotRTy6o2UX1abjZ-
"""
...
plt.plot(xData, yFitData, color = 'b', label = f"График с аппроксимацией " r'$I = a \cdot (\sqrt{bU}\cdot e^{-bU} + integral)$' f", a = {coeffs[0]:.3f} +- {deviation[0]:.4}, b = {coeffs[1]:.3f} +- {deviation[1]:.4}") #approximating praphic
